...
{
    public static string ToApiString(this ScalewayZone zone) => zone switch
    {
    ...
    public static ScalewayZone ParseZone(string value) => value switch
    {
    ...
    public static ScalewayRegion ToRegion(this ScalewayZone zone) => zone switch
    {
